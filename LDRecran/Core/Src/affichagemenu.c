...
*/
    ...
    */
    sprintf(chaine, "%02d:%02d", sTime.Hours, sTime.Minutes);

    if ((sTime.Seconds==0)&(eff==1))                     // si changement de minutes (seconde =0 et pas encore effac�)=> effacement de l'ancienne heure affich�e
        {
        setColor(COLOR_16_BLACK);
        drawString(45, 40, FONT_MD, chainep);
        eff=0;
