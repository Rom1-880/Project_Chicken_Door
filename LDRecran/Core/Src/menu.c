...
extern uint8_t langue;
extern int16_t longitude;
extern int8_t latitude;
extern uint8_t choixi;

uint8_t choix = 1;

extern void afficheecran1(void);
extern void afficheecran2(void);
extern void affichecarre(char c);
...
extern int8_t Touche_2_On ;
extern uint8_t Touche_3_On ;
extern uint16_t Compteur_appui_touche ;

extern uint8_t sens ;           // Sens du moteur de la porte
...
extern int8_t heureO;     // de 0 � 23
extern int8_t minO;         // de 0 � 59
extern int8_t heureF;     // de 0 � 23
extern uint8_t minF;         // de 0 � 59

extern int8_t minretard;        // de 0 � 90min;
extern int8_t minretardchange;     // indique si la modification de minretard a �t� prise en compte

extern int8_t latitude;        // france   // comprise entre -90 et 90� !!! Pb d'h�misph�re!!!
extern int16_t longitude;                // france   // comprise entre 0 et 360� !!!

extern uint8_t choixi;                   // permet le choix de r�glage entre lattitude et longitude
uint32_t j=0;                   // tempo

extern uint8_t ecran;              // �tat de la machine d'�tat
extern uint8_t varmenu;            // indique si on est dans le menu de r�glage. doit repasser � 0 au bout de 10s sans appui
extern uint8_t choix;                   // variable permettant de choisir le menu qu'on veut s�lectionner
//extern char langue;             // choix de la langue;
extern uint8_t langue;             // choix de la langue;

extern uint8_t modeO;               // heure fixe : 1, capteur Jour nuit : 2, GPS : 3
extern uint8_t modeF;               // heure fixe : 1, capteur Jour nuit : 2, GPS : 3
